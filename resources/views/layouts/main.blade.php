        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="#" class="nav-link px-2 link-dark"></a></li>
                    <li><a href="/dashboard_customer/{{ $dataCustomer->id }}" class="nav-link px-2 link-secondary {{ ($title === "Dashboard") ? 'btn btn-success' : '' }} ">Dashboards</a></li>
                ...
                <div class="dropdown text-end">
                    <a href="#" class=" btn btn-light d-block link-dark text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="/img/{{ $dataCustomer->image }}" alt="profile" width="32" height="32" class="rounded-circle shadow">
                    </a>
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                        <li><a class="dropdown-item" href="#" data-bs-toggle="offcanvas" data-bs-target="#profile" aria-controls="offcanvasRight">Profile</a></li>
                        <li>
