...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex text-dark fw-bolder fs-5 align-items-center my-1"><span class="text-muted fw-normal">Home - Master Data - Product Category - </span>&nbsp;Edit Product</h1>
        </div>
    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="kt_account_profile_details_form" class="form" method="POST" action="{{url('/back-product/'.$getDetailProduct->id.'/update-product')}}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="card-body border-top p-9">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{asset('image/upload/product/'.$getDetailProduct->thumbnail)}})"></div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="title" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('title') is-invalid @enderror" placeholder="Nama Produk" value="{{old('title', $getDetailProduct->title)}}" />
                                @error('title')
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="price" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('price') is-invalid @enderror" value="{{old('price', $getDetailProduct->price)}}" />
                                @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="sold" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('sold') is-invalid @enderror" placeholder="Terjual" value="{{old('sold', $getDetailProduct->sold)}}" />
                                @error('sold')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="size" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('size') is-invalid @enderror" placeholder="Ukuran" value="{{old('size', $getDetailProduct->size)}}" />
                                @error('size')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select name="category" aria-label="Select a Timezone" data-control="select2" class="form-select form-select-solid form-select-lg">
                                    ...
                                    <option value="{{$item->id}}" @if ($item->id == $getDetailProduct->category_id) selected @endif>{{$item->category_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="description" class="form-control form-control-lg form-control-solid @error('description') is-invalid @enderror" placeholder="Lorem ipsum dolor" value="{{old('description', $getDetailProduct->description)}}" />
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="sleeve" class="form-control form-control-lg form-control-solid @error('sleeve') is-invalid @enderror" placeholder="Lengan Panjang - Lengan Pendek" value="{{old('sleeve', $getDetailProduct->sleeve)}}" />
                                @error('sleeve')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="link_tokped" class="form-control form-control-lg form-control-solid @error('link_tokped') is-invalid @enderror" placeholder="Link Tokped" value="{{old('link_tokped', $getDetailProduct->link_tokped)}}"/>
                                @error('sleeve')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="link_shopee" class="form-control form-control-lg form-control-solid @error('link_shopee') is-invalid @enderror" placeholder="Link Shopee" value="{{old('link_shopee', $getDetailProduct->link_shopee)}}"/>
                                @error('sleeve')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
