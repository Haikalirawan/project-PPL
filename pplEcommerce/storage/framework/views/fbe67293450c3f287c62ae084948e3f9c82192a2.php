...
<?php endif; ?>
								<form name="frm-login" method="POST" action="<?php echo e(route('login')); ?>">
									...
									<fieldset class="wrap-input">
										...
										<input type="email" id="frm-login-uname" name="email" placeholder="Example@example.ex" :value="old('email')" required autofocus>
									</fieldset>
									<fieldset class="wrap-input">
									...
									<fieldset class="wrap-input">
										<label class="remember-field">
											<input class="frm-input " name="remember" id="rememberme" value="forever" type="checkbox"><span>Ingatkan saya</span>
										</label>
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/pplEcommerce/resources/views/auth/login.blade.php ENDPATH**/ ?>